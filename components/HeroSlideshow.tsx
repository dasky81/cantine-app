  ...
  return (
    <section className="relative h-[70vh] min-h-[520px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 pb-12">
        {/* Badge pillola */}
        <div className="mb-5 inline-flex items-center px-4 py-1.5 rounded-full bg-[#722F37]/80 backdrop-blur-sm border border-[#C9A84C]/30">
          <span className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#C9A84C]">
            Motore di ricerca AI · Cantine italiane
          </span>
        </div>

        <h1 className="text-5xl md:text-6xl font-bold leading-tight drop-shadow-lg mb-4">
          Scopri le cantine<br className="hidden sm:block" /> d&apos;Italia
        </h1>
        <p className="text-lg md:text-xl text-white/80 max-w-2xl">
          Descrivi il vino che cerchi, l&apos;AI trova la cantina perfetta per te
        </p>
      </div>
